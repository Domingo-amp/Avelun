...
<footer class="row">
	...
	<div class="col-md-5 footer-left"  style="height: 380px;">
		...
		<div style='margin-top:30px;'>
			Avelun es un sitio pensado para ti, nuestras mentoras te enseñaran todo lo que necesites saber para crecer profesionalmente,
	...
	<div class="col-lg" style='background-color:#444243; height: 50px; text-align:center; color:white; padding-top:15px; font-size:12px;' >
