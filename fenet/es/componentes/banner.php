...
?>
 	<font><b>¿Que Necesitas?</b></font>
	
	<form style="margin-top: 20px; font-size: 12px;">
		<textarea style="width: 400px;" placeholder="Cuentanos que necesitas..." id="necesidad"></textarea>
	</form>
    ...
    <div class="modal-content">
      ...
      <form id="modalForm1" action="#" method="post">    		
        	 ...
        	 <div class="form-group">
			  ...
			  <select name="pais" id="cars" class="form-control" id="exampleFormControlInput1" name="Pais">
