...
//$("#tamano").text(ventana_ancho);
	...
	$("#registrar").click(function () {
	    ...
	    $("#spamCondicion").text("You must complete all registration information");
		}else{
			var datos = "aceptado";
		}
	    ...
	    if (terminos == false){
	    	$("#spamTerminos").text("Accept the terms and conditions of the service");
	...
	$("#enviarMensaje").click(function () {
	    ...
	    if (mensajeNombre == "" || mensajeCorreo == "" || mensajeTelefono == "" || mensaje == ""  ){
	    	$("#spamMensaje").text("Complete all the fields to send the message");
		}else{
