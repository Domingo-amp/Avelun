...
<div class="card">
  <div class="card-header" style='text-align:center'><img src="img/logo.png"><h3>Provider Registry</h3></div>
    <div class="Allcont">
    <div class="Contend">
      <form class="form-group" method="post" action="#">

        <div class="labels"><input type="text" name="nombre" class="form-control" placeholder="First Name" required></div>
        <div class="labels"><input type="text" name="apellido" class="form-control" placeholder="Last Name" required></div>
        ...
        <div class="labels"><input type="text" name="posicion" class="form-control" placeholder="Position" required></div>
        <div class="labels"><input type="text" name="email"class="form-control" placeholder="Email" required></div>
        <div class="labels"><input type="text" name="telefonoTrabajo" class="form-control" placeholder="Work Phone" required></div>
        <div class="labels"><input type="text" name="telefonoMovil" class="form-control" placeholder="Movil Phone" required></div>
        <div class="labels"><input type="text" name="empresa" class="form-control" placeholder="Company" required></div>
        ...
        <div class="labels"><input type="text" name="telefonoEmpresa1" class="form-control" placeholder="Phone" required></div>
        <div class="labels"><input type="text" name="telefonoEmpresa2" class="form-control" placeholder="Phone-2" required></div>
        ...
        <div class="labels"><input type="text" name="ciudad" class="form-control" placeholder="City" required></div>
        <div class="labels"><input type="text" name="direccion" class="form-control" placeholder="Adress" required></div>
        <div class="labels"><input type="text" name="zip" class="form-control" placeholder="Zip Code" required></div>
        <div class="labels"><input type="text" name="rif" class="form-control" placeholder="RIF/NIT/EIN/RUT" required></div>
        <div class="labels"><input type="text" name="ejecutivo" class="form-control" placeholder="Executive" required></div>

        <div class="labels">
          <textarea class="form-control" name="descripcion" style="height: 165px" cols="33" placeholder="Description" required></textarea>
        </div>
        ...
        <div class="labels">
          ...
          <select name="tipo" class="form-control">
                      <option value='0' selected="true">Select</option>
                      <option value="01">Provider</option>
                      <option value="02">Distribuitor</option>
                      <option value="03">Store</option>
                      <option value="04">Provider/Distribuitor</option>
                      <option value="05">Provider/Store</option>
                      <option value="06">Store/Distribuitor</option>
          </select>
        </div>

        <div class="labels"><input type="text" name="servicios" class="form-control" placeholder="Services" required></div>
        <div class="labels"><input type="text" name="productos" class="form-control" placeholder="Products" required></div>
        <div class="labels"><input type="text" name="empleados" class="form-control" placeholder="N° Employes" required></div>
        <div class="labels"><input type="text" name="volumenVentas" class="form-control" placeholder="Vol. of Sales" required></div>
...
if (mysqli_num_rows($rs)>0)
{
    ...
    echo "<div class='alert alert-danger' style='text-align:center;' role='alert'>The contact you are trying to register is already registered!!</div>";
}else{
...
$conexion->query("INSERT INTO dataset_contactos VALUES (
  ...
  '$cont_estado'
    ...
    echo "<div class='alert alert-success' style='text-align:center;' role='alert'>Contact Was Saved Successfully!!</div>";
