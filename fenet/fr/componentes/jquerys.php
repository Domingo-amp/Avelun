...
//$("#tamano").text(ventana_ancho);
	...
	$("#registrar").click(function () {
	    ...
	    $("#spamCondicion").text("Vous devez compléter toutes les informations d'inscription");
		}else{
			var datos = "aceptado";
		}
	    ...
	    if (terminos == false){
	    	$("#spamTerminos").text("Accepter les termes et conditions du service");
	...
	$("#enviarMensaje").click(function () {
	    ...
	    if (mensajeNombre == "" || mensajeCorreo == "" || mensajeTelefono == "" || mensaje == ""  ){
	    	$("#spamMensaje").text("Remplissez tous les champs pour envoyer le message");
		}else{
