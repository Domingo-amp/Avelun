...
//$("#tamano").text(ventana_ancho);
	...
	$("#registrar").click(function () {
	    ...
	    $("#spamCondicion").text("Sie müssen alle Registrierungsinformationen ausfüllen");
		}else{
			var datos = "aceptado";
		}
	    ...
	    if (terminos == false){
	    	$("#spamTerminos").text("Akzeptieren Sie die Bedingungen des Dienstes");
	...
	$("#enviarMensaje").click(function () {
	    ...
	    if (mensajeNombre == "" || mensajeCorreo == "" || mensajeTelefono == "" || mensaje == ""  ){
	    	$("#spamMensaje").text("Füllen Sie alle Felder aus, um die Nachricht zu senden");
		}else{
